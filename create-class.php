...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $result = mysqli_query($conn, "SELECT * FROM tblclasses WHERE ClassNameNumeric='$classnamenumeric' and semester='$semester'");
        $num_rows = mysqli_num_rows($result);

        if ($num_rows) {
?>
            <script>
                alert("Class already exists with same ClassID.")
            </script>
            <?php
        } else {

            $sql = "INSERT INTO  tblclasses(ClassName,ClassNameNumeric,Section,semester) VALUES(:classname,:classnamenumeric,:section,:semester)";
