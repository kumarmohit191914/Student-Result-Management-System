...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $result = mysqli_query($conn, "SELECT * FROM tblsubjectcombination WHERE SubjectId='$subject'");
...
?>
    ...
    <?php
        ...
        if ($lastInsertId) {
            ?>
                <script>
                    alert('SubjectCombination added Succesfully.');
                </script>
                <?php
        } else {
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="subject" class="form-control" id="default" required="required">
                                                            ...
                                                            if ($query->rowCount() > 0) {
                                                                foreach ($results as $result) {   ?>
                                                                    <option value="<?php echo htmlentities($result->SubjectCode); ?>"> &nbsp;<?php echo htmlentities($result->SubjectName); ?> &nbsp;<?php echo htmlentities($result->SubjectCode); ?></option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                    </div>
