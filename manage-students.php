                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if (isset($_POST['mohit'])) {
                                                            ...
                                                            $sql = "SELECT tblstudents.StudentName,tblstudents.RollId,tblstudents.ClassId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section,tblclasses.semester from tblstudents join tblclasses on tblclasses.ClassNameNumeric=tblstudents.ClassId where ClassId=:stuid";
                                                            $query = $dbh->prepare($sql);
                                                                ...
                                                                foreach ($results as $result) {   ?>
                                                                    <tr>
                                                                        ...
                                                                        <!-- <td><?php if ($result->Status == 1) {
                                                                                    ...
                                                                                    ?></td> -->
                                                                        <td>
                                                                            <a class="btn btn-primary" href="edit-student.php?stid=<?php echo htmlentities($result->RollId); ?> &cid=<?php echo htmlentities($result->ClassId);?>">Edit </a>
                                                                            <a class="btn btn-success" href="delete_student.php?stid=<?php echo htmlentities($result->RollId); ?>&cid=<?php echo htmlentities($result->ClassId);?>">Delete</a>
