...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "DELETE from tblstudents where RollId=:stid and ClassId=:cid";
        $sql1="DELETE from tblresult where StudentId=:stid and ClassId=:cid";
