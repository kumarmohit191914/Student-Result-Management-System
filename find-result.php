                        ...
                        <div class="panel-body p-20">
                            ...
                            <form action="result.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="rollid" placeholder="Enter Your Roll Id" autocomplete="off" name="rollid" required>
                                </div>
                                <div class="form-group">
                                    <label for="default" >Select Class</label>
                                ...
                                <div class="from-group">
                                    <label for="default">Enter DOB: </label>
                                    <input type="date" name="dob" id="dob" required style="width: 100%;">
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <button type="submit" class="btn btn-success btn-labeled pull-right" style="height:35px">
                                        <a href="index.php" style="color:white;">Back to Home</a></button>
                                </div>
                            </form>
