...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $dob = $_POST['dob'];
        $status = $_POST['status'];
        $sql = "update tblstudents set StudentName=:studentname,RollId=:roolid,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,Status=:status where RollId=:stid and ClassId=:cid ";
        $sql1="update tblresult set StudentId=:roolid where StudentId=:stid and ClassId=:cid";
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) {  ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="classname" class="form-control" id="classname" value="<?php echo htmlentities($result->ClassName) ?>&nbsp;<?php echo htmlentities($result->Section) ?>&nbsp;<?php echo htmlentities($result->semester) ?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
