...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['update'])) {
        ...
        $cid = $_GET['classid'];
        $sql = "update tblclasses set ClassName=:classname,Section=:section,ClassNameNumeric=:classnamenumeric,semester=:semester where ClassNameNumeric=:cid ";
        $sql1="update tblsubjectcombination set ClassId=:classnamenumeric where ClassId=:cid";
        $sql2="update tblstudents set ClassId=:classnamenumeric where ClassId=:cid";
        $sql3="update tblresult set ClassId=:classnamenumeric where ClassId=:cid";
        ...
        $query1->bindParam(':classnamenumeric', $classnamenumeric, PDO::PARAM_STR);

        $query2->bindParam(':classnamenumeric', $classnamenumeric, PDO::PARAM_STR);

        $query3->bindParam(':classnamenumeric', $classnamenumeric, PDO::PARAM_STR);
