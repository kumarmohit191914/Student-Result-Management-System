    ...
    if (isset($_POST['submit'])) {
        ...
        foreach ($_POST['id'] as $count => $id) {
            ...
            for ($i = 0; $i <= $count; $i++) {
                ...
                $sql = "update tblresult  set marks=:mrks where StudentId=:iid and ClassId=:cid";
